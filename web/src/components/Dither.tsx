...
void main() {
  ...
  outColor = clamp(outColor * 0.15, 0.0, 0.5); 
...
type DitheredWavesProps = Required<Omit<DitherProps, 'style'>>;
...
export default function Dither({
  ...
  waveFrequency = 3,
  waveAmplitude = 0.3,
  waveColor = [0.3, 0.5, 0.5], // Darkened color
  colorNum = 4, // More pronounced: 2 = b/w, 3 = b/w/gray
  pixelSize = 3, // More pixelated
